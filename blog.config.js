...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '能量怪兽', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '致力于帮助健身房打造更好的品质化服务。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://power-monster.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '能量怪兽', // 网站关键词 英文逗号隔开
